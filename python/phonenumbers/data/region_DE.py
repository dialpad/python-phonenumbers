...
PHONE_METADATA_DE = PhoneMetadata(id='DE', country_code=49, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='1(?:(?:5(?:[0-25-9]\\d\\d|3(?:10|33))|7[26-9]\\d\\d)\\d{6}|6[023]\\d{7,8})|17(?:\\d{8}|1\\d{10})', example_number='15123456789', possible_length=(10, 11, 13)),
